...
TOKEN = '7590577404:AAH79ucdPeEoaUXTdTfbiQMAuH2Cuibrf1Y'
bot = telebot.TeleBot(TOKEN, threaded=False)

# 🛡️ List of authorized user IDs (replace with actual IDs)
AUTHORIZED_USERS = [8033268359]
...
def owner(message):
    ...
    bot.send_message(message.chat.id, "📞 Contact the owner: @venomXcrazy ki jagah")
